...
const propertySchema = z.object({
  ...
  // Nuevas características para fincas (opcionales)
...
const propertyTypes = [
  ...
  { value: "farm", label: "Finca" }, // Añadido tipo finca
];
...
const PropertyForm = () => {
  ...
  function onSubmit(values: z.infer<typeof propertySchema>) {
    ...
    // En una implementación real, enviarías estos datos y las imágenes al backend
    console.log({
      ...values,
    ...
    setTimeout(() => {
      ...
      navigate("/properties"); // Redirigir a la lista de propiedades después de guardar
    }, 1500);
  }

  function saveDraft() {
    const formValues = form.getValues();
    // En una implementación real, guardarías como borrador
  ...
  // Determinar si mostrar las características de finca
    ...
    <div className="form-container mb-12">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500">
          Complete los detalles de la propiedad para registrarla en el sistema
        </p>
      </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea 
                        placeholder="Describe los aspectos más destacados de la propiedad..." 
                        className="min-h-32" 
                        {...field} 
                      />
                    </FormControl>
